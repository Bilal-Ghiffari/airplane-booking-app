...
export default function LoadingFlightDetail() {
  return (
    <div className="flex flex-col items-center gap-[30px] mt-[61px] pb-[30px]">
      <Skeleton className="bg-gray-300 w-[300px] h-8" />
        ...
        <div className="flex flex-col gap-[10px] w-full">
          ...
          <div className="flex justify-between">
            <div className="flex flex-col gap-[2px] text-center">
              <Skeleton className="bg-gray-300 w-[60px] h-5" />
              <Skeleton className="bg-gray-300 w-[40px] h-4" />
            </div>
            <div className="flex flex-col gap-[2px] text-center">
              <Skeleton className="bg-gray-300 w-[60px] h-5" />
              <Skeleton className="bg-gray-300 w-[40px] h-4" />
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          <div className="flex justify-between items-center">
            <div className="flex flex-col gap-[2px]">
              <Skeleton className="bg-gray-300 w-[100px] h-5" />
              <Skeleton className="bg-gray-300 w-[100px] h-5" />
            </div>
